...
//        super.setUp()
//        
//        mockViewModel = CurrencyConverterViewModel(currencyService: mockCurrencyService, notificationService: mockNotificationService, selectedCurrency: <#any CurrencyItem#>)
